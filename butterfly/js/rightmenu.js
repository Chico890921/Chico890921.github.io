...
window.oncontextmenu = function(event){
    let pageX = event.clientX + 10;	//加10是為了防止顯示時鼠標遮在菜單上
    let pageY = event.clientY;
    
    // 菜單默認顯示在鼠標右下方，當鼠標靠右或靠下時，將菜單顯示在鼠標左方\上方
...
window.addEventListener('click',function(){kk.showRightMenu(false);});	//隱藏菜單
...
window.addEventListener('load',function(){kk.switchTheme(true);});	//頁面加載時，通過緩存加載主題
